...
eq(first.groundPaddingByFrame[0],2,'standing frame anchor')
eq(first.groundPaddingByFrame[1],1,'walking frame anchor')
...
local masked=A.sprite(2,sheet({0,0,0}),2,4,3,first.groundPadding,first.groundPaddingByFrame)
eq(masked.groundPaddingByFrame[0],2,'masked art retains original standing anchor')
